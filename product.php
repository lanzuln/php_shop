                        ...
                        <div class="product-img-large">
                            <div class="img-large-slider common-slider" data-slick='{
                                ...
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/39.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/39.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/38.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/38.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/37.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/37.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/36.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/36.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/34.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/34.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/30.jpg" data-fancybox="gallery">
                                        <img src="<?php echo BASE_URL;?>assets/img/products/bags/30.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="<?php echo BASE_URL;?><?php echo BASE_URL;?>assets/img/products/bags/32.jpg" data-fancybox="gallery">
        ...
        <div class="container">
            <div class="tab-list product-tab-list">
                <nav class="nav product-tab-nav">
                    <a class="product-tab-link tab-link active" href="<?php echo BASE_URL;?>#pdescription" data-bs-toggle="tab">Description</a>
                    <a class="product-tab-link tab-link" href="<?php echo BASE_URL;?>#pspecification" data-bs-toggle="tab">Specification</a>
                </nav>
            </div>

...
<body>
    ...
    <header class="navbar navbar-custom-color sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-nav flex-row">
            ...
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="profile.html"><i class="fas fa-user"></i> Edit Profile</a>
            </div>
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="login.html"><i class="fas fa-sign-out-alt"></i> Logout</a>
            </div>
        </div>
    </header>

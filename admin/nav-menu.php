<header class="navbar navbar-custom-color sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="<?php echo ADMIN_URL;?>index.php">Admin Panel</a>
    ...
    <div class="navbar-nav flex-row">
        <div class="nav-item text-nowrap">
            <a class="nav-link px-3" href="<?php echo ADMIN_URL;?>javascript:void;">Logged in as <?php echo $_SESSION['admin']['name'];?></a>
        </div>
        <div class="nav-item text-nowrap">
